...
class MantenimentLocalitzacioView
{

    public function showMantenimentLocalitzacio($ObjectArray, $data = null, $errors = null, $updateData = null, $isCreate = true)
    {
    ...
    {
        if ($isCreate) {
            $table = '<form method="post" action="?MantenimentLocalitzacio/create">';
        } else {
            $table = '<form method="post" action="?MantenimentLocalitzacio/update">';
        }
        $table .= '<table>
        <thead>
            <tr>';
    ...
    <tbody>
        ...
        <div class="button-container">
            <a href="?MantenimentLocalitzacio/showUpdate&id=' . $result->id . '">Actualizar</a>
 <a href="?MantenimentLocalitzacio/delete&id=' . $result->id . '" class="delete-link" data-id="' . $result->id . '">Eliminar</a>
        </div>
    </td>
</tr>';
        }
