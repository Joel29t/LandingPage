...
class MantenimentDataView
{

    public function showMantenimentData($ObjectArray, $data = null, $errors = null, $updateData = null, $isCreate = true)
    {
    ...
    {
        if ($isCreate) {
            $table = '<form method="post" action="?MantenimentData/create">';
        } else {
            $table = '<form method="post" action="?MantenimentData/update">';
        }
        $table .= '<table>
        <thead>
            <tr>';
    ...
    <tbody>
        ...
        <div class="button-container">
             <a href="?MantenimentData/showUpdate&id=' . $result->id . '">Actualizar</a>
             <a href="?MantenimentData/delete&id=' . $result->id . '" class="delete-link" data-id="' . $result->id . '">Eliminar</a>
        </div>
    </td>
</tr>';
        }
